...
| :---------------------: | :---------------------: | :--------------------------------: | :------------------------------: |
| ![A1-1](plots/A1-1.png) | ![A1-2](plots/A1-2.png) |      ![A1-3](plots/A1-3.png)       |     ![A1-4](plots/A1-4.png)      |
...
<img src="plots/A1-5.png" alt="A1-5" style="zoom: 50%;" />
...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
|                   ![A2-2](plots/A2-2.png)                    |                   ![A2-3](plots/A2-3.png)                    |

##### SVD Analysis

<img src="plots/A2-1.png" alt="A2-1" style="zoom:72%;" />
...
| :---------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: |
| ![A3-1](plots/A3-1.png) |                  ![A3-2](plots/A3-2.png)                  |                  ![A3-3](plots/A3-3.png)                  |                  ![A3-4](plots/A3-4.png)                  |
...
|        Sinogram         |                      FBP (Baseline)                       |                            TK0                            |                            TK1                            |
| :---------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: |
| ![A3-1](plots/A3-5.png) |                  ![A3-2](plots/A3-6.png)                  |                  ![A3-3](plots/A3-7.png)                  |                  ![A3-4](plots/A3-8.png)                  |
...
|        Sinogram         |                      FBP (Baseline)                       |                            TK0                            |                            TK1                            |
| :---------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: | :-------------------------------------------------------: |
| ![A3-1](plots/A3-9.png) |                 ![A3-2](plots/A3-10.png)                  |                 ![A3-3](plots/A3-11.png)                  |                 ![A3-4](plots/A3-12.png)                  |
...
| :--------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="plots/A4-1.png" alt="A4-1" style="zoom: 50%;" /> | <img src="plots/A4-2.png" alt="A4-2" style="zoom: 50%;" /> |
...
| :-------------------------------------------------------: | :-------------------------------------------------------: |
| <img src="plots/A4-1.png" alt="A4-1" style="zoom:50%;" /> | <img src="plots/A4-3.png" alt="A4-2" style="zoom:50%;" /> |
...
| :-------------------------------------------------------: | :-------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="plots/A4-1.png" alt="A4-1" style="zoom:50%;" /> | <img src="plots/A4-4.png" alt="A4-4" style="zoom:50%;" /> | <img src="plots/A4-7.png" alt="A4-7" style="zoom: 67%;" /> |
...
| :------------------------: | :--------------------------: | :----------------------------: |
|  ![A4-8](plots/A4-8.png)   |   ![A4-9](plots/A4-9.png)    |    ![A4-5](plots/A4-5.png)     |
...
| :-------------------------------------------------------: | :-------------------------------------------------------: |
| <img src="plots/A5-1.png" alt="A5-1" style="zoom:50%;" /> | <img src="plots/A5-2.png" alt="A5-2" style="zoom:50%;" /> |
...
| :---------------------: | :---------------------: | :---------------------: |
| ![A5-3](plots/A5-3.png) | ![A3-3](plots/A5-4.png) | ![A3-4](plots/A5-5.png) |

+ *Radon Transform parameters:* $n_\text{projs}=128$, $n_\text{angles}=30$, $\theta_\text{max}=\pi$

|      Noise Level 0      |     Noise Level 500     |    Noise Level 1000     |
| :---------------------: | :---------------------: | :---------------------: |
| ![A5-3](plots/A5-6.png) | ![A3-3](plots/A5-7.png) | ![A3-4](plots/A5-8.png) |

+ *Radon Transform parameters:* $n_\text{projs}=128$, $n_\text{angles}=90$, $\theta_\text{max}=\pi/4$

|      Noise Level 0      |     Noise Level 500      |     Noise Level 1000     |
| :---------------------: | :----------------------: | :----------------------: |
| ![A5-3](plots/A5-9.png) | ![A3-3](plots/A5-10.png) | ![A3-4](plots/A5-11.png) |
...
| :--------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="plots/B1-1.png" alt="B1-1" style="zoom: 50%;" /> | <img src="plots/B1-2.png" alt="B1-2" style="zoom: 50%;" /> |
...
|         full angle with undersampled projections          |                      limited angles                       |
| :-------------------------------------------------------: | :-------------------------------------------------------: |
| <img src="plots/B2-1.png" alt="B1-1" style="zoom:67%;" /> | <img src="plots/B2-2.png" alt="B1-2" style="zoom:67%;" /> |

Reconstruct by corrected sinograms:

|          full angle with undersampled projections          |                       limited angles                       |
| :--------------------------------------------------------: | :--------------------------------------------------------: |
| <img src="plots/B2-3.png" alt="B1-1" style="zoom: 50%;" /> | <img src="plots/B2-4.png" alt="B1-2" style="zoom: 50%;" /> |
...
|                    |         full angle with undersampled projections          |                      limited angles                       |
| :----------------: | :-------------------------------------------------------: | :-------------------------------------------------------: |
|    **Filtered**    | <img src="plots/B3-1.png" alt="B3-1" style="zoom:67%;" /> | <img src="plots/B3-3.png" alt="B3-2" style="zoom:67%;" /> |
| **Reconstruction** |                  ![B3-3](plots/B3-2.png)                  |                  ![B3-4](plots/B3-4.png)                  |
...
|                    |          full angle with undersampled projections          |                       limited angles                       |
| :----------------: | :--------------------------------------------------------: | :--------------------------------------------------------: |
|   **Corrected**    | <img src="plots/B4-2.png" alt="B4-2" style="zoom: 50%;" /> | <img src="plots/B4-5.png" alt="B4-5" style="zoom: 50%;" /> |
|    **Filtered**    | <img src="plots/B4-3.png" alt="B3-1" style="zoom: 50%;" /> | <img src="plots/B4-6.png" alt="B3-2" style="zoom: 50%;" /> |
| **Reconstruction** | <img src="plots/B4-4.png" alt="B3-3" style="zoom:50%;" />  | <img src="plots/B4-7.png" alt="B3-4" style="zoom:50%;" />  |
